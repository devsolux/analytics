export type TrackedProperties = {
   ...
   * @example 'analytics.devsolux.com'
   */
  hostname: string;
...
export type DevSoluxTracker = {
  track: {
     ...
     *
     * @example ```
     * devsolux.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * devsolux.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * devsolux.track((props) => ({ ...props, url: path }));
     * ```
     */
