...
export function TestConsole({ websiteId }: { websiteId: string }) {
  ...
  function handleClick() {
    window['devsolux'].track({ url: '/page-view', referrer: 'https://www.google.com' });
    window['devsolux'].track('track-event-no-data');
    window['devsolux'].track('track-event-with-data', {
      test: 'test-data',
      boolean: true,
      booleanError: 'true',
      time: new Date(),
  ...
  return (
    <Page isLoading={isLoading} error={error}>
      <Head>
        <title>{website ? `${website.name} | DevSolux Console` : 'DevSolux Console'}</title>
      </Head>
        ...
        <>
          ...
          <div className={styles.test}>
            <div>
              ...
              <div>
                <a href="https://www.google.com" data-devsolux-event="external-link-direct">
              ...
              <div>
                <a
                  ...
                  data-devsolux-event="external-link-tab"
                  target="_blank"
                  rel="noreferrer"
                >
                  external link (tab)
            ...
            <div>
              ...
              <Button id="send-event-button" data-devsolux-event="button-click" variant="primary">
                Send event
              </Button>
              <p />
              <Button
                id="send-event-data-button"
                data-devsolux-event="button-click"
                data-devsolux-event-name="bob"
                data-devsolux-event-id="123"
                variant="primary"
              >
