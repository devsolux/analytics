...
export const AUTH_TOKEN = 'devsolux.auth';
export const LOCALE_CONFIG = 'devsolux.locale';
export const TIMEZONE_CONFIG = 'devsolux.timezone';
export const DATE_RANGE_CONFIG = 'devsolux.date-range';
export const THEME_CONFIG = 'devsolux.theme';
export const DASHBOARD_CONFIG = 'devsolux.dashboard';
export const SHARE_TOKEN_HEADER = 'x-devsolux-share-token';
